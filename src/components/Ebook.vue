<template>
	<div class="ebook">
		...
		<menu-bar :isMenuShow="isMenuShow" :fontSizeList="fontSizeList" :defaultFontSize="defaultFontSize" ref="menuBar"
							@setFontSize="setFontSize" :themeList="themeList" :defaultTheme="defaultTheme" @setTheme="setTheme"
							:bookAvailabel="bookAvailabel" @onProgressChange="onProgressChange" :nav="nav" @jumpTo="jumpTo"
							@hideTitle="hideTitle"
		></menu-bar>
	</div>
</template>
