...
<div class="menu-bar" >
  <transition name="slide-up">
    <div class="menu-wrapper" :class="{'hide-box-shadow': settingShow}" v-show="isMenuShow && !ifShowContent && !settingShow">
      <div class="icon-wrapper" @click="showSetting(3)">
        <span class="icon-menu icon" :style="{cursor: this.bookAvailabel?'cursor':'not-allowed'}" :key="bookAvailabel"></span>
      </div>
      <div class="icon-wrapper" @click="showSetting(2)">
        <span class="icon-progress icon" :style="{cursor: this.bookAvailabel?'cursor':'not-allowed'}" :key="bookAvailabel"></span>
      </div>
  ...
  <content-view :ifShowContent="ifShowContent" v-show="ifShowContent" :nav="nav" @jumpTo="jumpTo"></content-view>
</div>
</template>
