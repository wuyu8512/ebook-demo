...
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_43__, __WEBPACK_EXTERNAL_MODULE_72__) {
...
function parse(markup, mime, forceXMLDom) {
	...
	if (typeof DOMParser === "undefined" || forceXMLDom) {
		Parser = __webpack_require__(43).DOMParser;
	} else {
		Parser = DOMParser;
	}
...
var _undefined = __webpack_require__(35)(); // Support ES3 engines
...
var _themes = __webpack_require__(19);
  ...
  */
   ...
   */
		...
		value: function columns(width, height, columnWidth, gap) {
			...
			this.css('font-size', _themes.fontSize.size);
...
var fontSize = exports.fontSize = fontSzie;
...
var _spine = __webpack_require__(44);

var _spine2 = _interopRequireDefault(_spine);

var _locations = __webpack_require__(48);
...
var _packaging = __webpack_require__(50);
...
var _resources = __webpack_require__(52);
		...
		value: function render(_request) {
			...
			this.load(_request).then(function (contents) {
				...
				if (typeof XMLSerializer === "undefined" || isIE) {
					Serializer = __webpack_require__(46).XMLSerializer;
				} else {
...
//if(typeof require == 'function'){
	var XMLReader = __webpack_require__(47).XMLReader;
